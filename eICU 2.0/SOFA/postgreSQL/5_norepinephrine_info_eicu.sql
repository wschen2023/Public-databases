-- Norepinephrine information foreICU Collaborative Research Database 2.0
-- 20240930
...
drop table if exists eicu_crd.norepinephrine_info_eicu;
create table eicu_crd.norepinephrine_info_eicu as
...
, norepinephrine_in_part_2_pre as (
...
, norepinephrine_in_part_2 as (
  ...
  from norepinephrine_in_part_1 dip_1
  left join norepinephrine_in_part_2_pre dip_2
...
, norepinephrine_2 as (
  ...
  from norepinephrine_in_part idn
  inner join eicu_crd.medication md
