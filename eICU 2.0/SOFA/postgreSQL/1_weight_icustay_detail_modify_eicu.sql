-- icustay_detail's admissionweight and dischargeweight for eICU Collaborative Research Database 2.0
-- 20240930
...
drop table if exists eicu_crd.weight_icustay_detail_modify_eicu;
create table eicu_crd.weight_icustay_detail_modify_eicu as
