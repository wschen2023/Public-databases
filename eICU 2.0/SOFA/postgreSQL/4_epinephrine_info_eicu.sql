-- Epinephrine information for eICU Collaborative Research Database 2.0
-- 20240930
...
drop table if exists eicu_crd.epinephrine_info_eicu;
create table eicu_crd.epinephrine_info_eicu as
...
, epinephrine_in_part_2 as (
  ...
  from epinephrine_in_part_1 dip_1
  left join epinephrine_in_part_2_pre dip_2
...
, epinephrine_2 as (
  ...
  from epinephrine_in_part idn 
  left join eicu_crd.medication md
