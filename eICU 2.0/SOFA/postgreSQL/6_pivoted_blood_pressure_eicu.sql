-- Blood pressure information for eICU Collaborative Research Database 2.0
-- 20240930
...
drop table if exists eicu_crd.pivoted_blood_pressure_eicu;
create table eicu_crd.pivoted_blood_pressure_eicu as
...
, vitala_bp_0 as (
	...
	, round(COALESCE(cast(noninvasivemean as numeric), cast((noninvasivediastolic + (noninvasivesystolic - noninvasivediastolic)/3) as numeric)),0) as mbp
